...
- [align-lock] 分鏡席經 runBoards 交可見板、切格、鏡號／鏡內位置同 QC 收據。文字 callsheet 只係草稿。十一鏡唔等於十六格；補格只換指定壞格，空格唔開新鏡。
