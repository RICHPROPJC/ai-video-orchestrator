...
- [w8] stills.noun field=scenes.location saw=總統府地下審判室 rule=scenes[].location 寫畫面見到嘅房 2–8 字（地下室、宿舍、走廊）。機構／劇名只入 heading。beats.action 只寫見到嘅郁動同物件，唔寫故仔、唔寫片。 hits=1 status=trial src=SC-0915-LD0F
