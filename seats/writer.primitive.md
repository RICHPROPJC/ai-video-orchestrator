...
- [w13] schema.action field=beats.action saw=俯身 rule=Action 開首絕對唔好用 '俯身'、'轉身'、'抬頭' 等姿勢/狀態詞。必須直接用對物體做嘅物理動詞（如放、拿、踢、指）開首。狀態詞係描述身體位置，唔係鏡頭見得到嘅交互動作。 hits=1 status=trial src=SC-0924-BP5S
