...
const PINNED: Record<string, Partial<CapabilityEntry>> = {
  ...
  "pb.stance.sit.v1": { kind: "playbook", receipt: F2, cast: ["hero"], doneState: "sit keyed", preconditions: ["character spawned"] },
  "pb.stance.lie.v1": { kind: "playbook", receipt: `${F2}/lie`, cast: ["hero"], doneState: "lie keyed", preconditions: ["character spawned"] },
  "pb.stance.kneel.v1": { kind: "playbook", receipt: `${F2}/kneel`, cast: ["hero"], doneState: "kneel keyed", preconditions: ["character spawned"] },
  "pb.stance.crouch.v1": { kind: "playbook", receipt: `${F2}/crouch`, cast: ["hero"], doneState: "crouch keyed", preconditions: ["character spawned"] },
  "pb.stance.lean.v1": { kind: "playbook", receipt: `${F2}/lean`, cast: ["hero"], doneState: "lean keyed", preconditions: ["character spawned"] },
  "pb.stance.turn-away.v1": { kind: "playbook", receipt: `${F2}/turn_away`, cast: ["hero"], doneState: "turn_away keyed", preconditions: ["character spawned"] },
  ...
  sit_stance: { kind: "skill", receipt: F2, cast: ["hero"], doneState: "sit keyed", preconditions: ["character spawned"] },
  lie_stance: { kind: "skill", receipt: `${F2}/lie`, cast: ["hero"], doneState: "lie keyed", preconditions: ["character spawned"] },
  kneel_stance: { kind: "skill", receipt: `${F2}/kneel`, cast: ["hero"], doneState: "kneel keyed", preconditions: ["character spawned"] },
  crouch_stance: { kind: "skill", receipt: `${F2}/crouch`, cast: ["hero"], doneState: "crouch keyed", preconditions: ["character spawned"] },
  lean_stance: { kind: "skill", receipt: `${F2}/lean`, cast: ["hero"], doneState: "lean keyed", preconditions: ["character spawned"] },
  turn_away_stance: { kind: "skill", receipt: `${F2}/turn_away`, cast: ["hero"], doneState: "turn_away keyed", preconditions: ["character spawned"] },
